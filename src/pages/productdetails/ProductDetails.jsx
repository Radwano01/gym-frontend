                ...
                <div className="options">
                  {product.p_arms && (
                    <div className="option">
                      ...
                      {errorMessage === 2 && (<div className="error-message"><h3>{t("SingleProduct-Arm-Error-Message")}</h3></div>)}
                    </div>
                  )}
                  ...
                  {product.p_sizes && (
                    <div className="option">
                      ...
                      {errorMessage === 3 && (<div className="error-message"><h3>{t("SingleProduct-Sizes-Error-Message")}</h3></div>)}
                    </div>
                  )}
                  ...
                  {product.p_colors && (
                    <div className="option">
                      ...
                      {errorMessage === 1 && (<div className="error-message"><h3>{t("SingleProduct-Color-Error-Message")}</h3></div>)}
                    </div>
                  )}
